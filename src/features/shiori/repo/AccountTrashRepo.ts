// src/features/shiori/repo/accountTrashRepo.ts
...
/**
 * 계정 탈퇴 요청
 * - profiles + shiori_items + shiori_comments + support_tickets soft delete
 * - 30일 purge_at 설정
...
export async function dbRestoreAccountIfPossible(): Promise<RestoreAccountResult> {
  ...
  const row = data as RestoreAccountResult | null;
